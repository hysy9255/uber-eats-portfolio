...
export class ClientOrderController {
  ...
  async createOrder(
    ...
    return await this.command.createOrder(clientId, dto);
  }
  ...
  async getOrderForClient(
    ...
    const { clientId } = req[AUTH_USER] as ClientUser;
    return await this.query.getOrder(clientId, orderId);
  }
  ...
  async getOnGoingOrdersForClient(
    ...
    const { clientId } = req[AUTH_USER] as ClientUser;
    return await this.query.getOrders(clientId, ONGOING_ORDER_STATUSES);
  }
  ...
  async getOrderHistoryForClient(
    ...
    const { clientId } = req[AUTH_USER] as ClientUser;
    return await this.query.getOrders(clientId, FINISHED_ORDER_STATUSES);
  }
}
